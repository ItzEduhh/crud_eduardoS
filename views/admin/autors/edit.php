...
<div class="card shadow-sm" id="formView">
    ...
    <div class="card-body">
        <form method="post" action="/admin/autors/update" enctype="multipart/form-data" class="">
            <input type="hidden" name="id" value="<?= $this->e($autor['id']) ?>">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="name" class="form-label">Nome</label>
                    <input type="text" class="form-control" id="name" name="name" placeholder="Digite o nome"
                           value="<?= $this->e(($autor['name'] ?? '')) ?>" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="text" name="text"
                           placeholder="Digite o preço" value="<?= $this->e(($autor['text'] ?? '')) ?>" required>
            ...
            <div class="d-flex gap-3">
                ...
                <a href="/admin/autors" class="btn align-self-end">
