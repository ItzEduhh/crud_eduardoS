<?php $this->layout('layouts/admin', ['title' => 'Editar Música']) ?>

<?php $this->start('body') ?>
<div class="card shadow-sm" id="formView">
    <?php $this->insert('partials/admin/form/header', ['title' => 'Editar Música']) ?>
    <div class="card-body">
        <form method="post" action="/admin/musics/update" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="Digite o nome"
                           value="<?= $this->e($music->name ?? '') ?>" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="text" name="text" placeholder="Digite o texto"
                           value="<?= $this->e($music->text ?? '') ?>" required>
                    <?php if (!empty($errors['text'])): ?>
                        <div class="text-danger"><?= $this->e($errors['text']) ?></div>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="autor_id" name="autor_id" required>
                        ...
                        <?php foreach ($autors as $autor): ?>
                            <option value="<?= $this->e($autor->id) ?>"
                                <?= (($music->autor_id ?? '') == $autor->id ? 'selected' : '') ?>>
                                <?= $this->e($autor->name) ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="producer_id" name="producer_id" required>
                        ...
                        <?php foreach ($producers as $producer): ?>
                            <option value="<?= $this->e($producer->id) ?>"
                                <?= (($music->producer_id ?? '') == $producer->id ? 'selected' : '') ?>>
